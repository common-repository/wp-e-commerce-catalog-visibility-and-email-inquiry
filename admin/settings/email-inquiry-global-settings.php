...
class WPEC_EI_Global_Settings extends WPEC_Email_Inquiry_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Email Inquiry Settings successfully saved.', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'error_message'		=> __( 'Error: Email Inquiry Settings can not save.', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'reset_message'		=> __( 'Email Inquiry Settings successfully reseted.', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
			);
	...
	public function after_save_settings() {
		...
		if ( ( isset( $_POST['bt_save_settings'] ) || isset( $_POST['bt_reset_settings'] ) ) && get_option( 'wpec_email_inquiry_pro_clean_on_deletion' ) == 0  )  {
	...
	public function init_form_fields() {
		...
		$roles = $wp_roles->get_names();
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				'name'		=> __( 'Product Cards', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Email Inquiry Feature', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'desc'		=> __( "ON to show Button / Link Text on Product Cards (grid view) display.", 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
			...
			array(
            	'name' => __( 'House Keeping :', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
                'type' => 'heading',
           	),
			array(  
				'name' 		=> __( 'Clean up on Deletion', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'desc' 		=> __( "On deletion (not deactivate) the plugin will completely remove all tables and data it created, leaving no trace it was ever here.", 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'id' 		=> 'wpec_email_inquiry_pro_clean_on_deletion',
				'type' 		=> 'onoff_checkbox',
				'default'	=> '1',
				'separate_option'	=> true,
				'checked_value'		=> '1',
	...
	?>
    	<tr valign="top" class="hide_inquiry_button_yellow_message_tr" style=" ">
            ...
            <?php 
				$hide_inquiry_button_blue_message = '<div><strong>'.__( 'Note', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ).':</strong> '.__( "If you do not apply the Show Email Inquiry Button Rule to your role i.e. 'administrator' you will need to either log out or open the site in another browser where you are not logged in to see the Email Inquiry Button feature is activated.", 'wp-e-commerce-catalog-visibility-and-email-inquiry' ).'</div>
                <div style="clear:both"></div>
                <a class="hide_inquiry_button_yellow_message_dontshow" style="float:left;" href="javascript:void(0);">'.__( "Don't show again", 'wp-e-commerce-catalog-visibility-and-email-inquiry' ).'</a>
                <a class="hide_inquiry_button_yellow_message_dismiss" style="float:right;" href="javascript:void(0);">'.__( "Dismiss", 'wp-e-commerce-catalog-visibility-and-email-inquiry' ).'</a>
                <div style="clear:both"></div>';
