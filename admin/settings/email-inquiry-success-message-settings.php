...
class WPEC_EI_Success_Message_Settings extends WPEC_Email_Inquiry_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Success Message successfully saved.', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'error_message'		=> __( 'Error: Success Message can not save.', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'reset_message'		=> __( 'Success Message successfully reseted.', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Success Message', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Success Message Setup', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Success Message', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'desc' 		=> __( 'Message that user will see after their Inquiry is sent.', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'id' 		=> 'wpec_pcf_contact_success',
				'type' 		=> 'wp_editor',
				'textarea_rows'		=> 30,
				'default'	=> __( "Thanks for your inquiry - we'll be in touch with you as soon as possible!", 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
