...
class WPEC_Email_Inquiry_Admin_UI
{
	 ...
	 */
	public $pro_plugin_page_url = 'https://a3rev.com/shop/catalog-visibilty-and-email-inquiry/';
	...
	public function upgrade_top_message( $echo = false, $setting_id = '' ) {
		$upgrade_top_message = sprintf( '<div class="pro_feature_top_message">'
			. __( 'Settings inside this yellow border are %s Features.', 'wp-e-commerce-catalog-visibility-and-email-inquiry' )
			. '<br />'
			. __( 'Upgrade to the <a href="%s" target="_blank">%s</a> to activate these settings.', 'wp-e-commerce-catalog-visibility-and-email-inquiry' )
			. '</div>'
			, apply_filters( $this->plugin_name . '_' . $setting_id . '_pro_version_name', apply_filters( $this->plugin_name . '_pro_version_name', __( 'Pro Version', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ) ) )
