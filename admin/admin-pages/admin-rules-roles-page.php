...
{	
	...
	public function page_data() {
		...
		$page_data = array( 
			array(
				'type'				=> 'menu',
				'page_title'		=> __( 'WPEC Catalog & Email Pro', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'menu_title'		=> __( 'WPEC Catalog & Email Pro', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
			...
			array(
				...
				'page_title'		=> __( 'Rules & Roles', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'menu_title'		=> __( 'Rules & Roles', 'wp-e-commerce-catalog-visibility-and-email-inquiry' ),
				'capability'		=> 'manage_options',
				'menu_slug'			=> $this->menu_slug,
				'function'			=> 'wpec_ei_rules_roles_page_show',
				'admin_url'			=> 'admin.php',
		...
		if ( isset( $_GET['page'] ) &&  in_array( $_GET['page'], array( 'wpec-cart-email' ) ) ) {
			if ( ! isset( $_SESSION ) ) {
				@session_start();
			}
		}
